.PHONY: format lint type test build examples corpus mncds-corpus interoperability release-candidate-schema release-candidate-corpus release-candidate-independent recursive-study release-candidate-check docs core-check forge-integration-test edgestream-smoke edgestream-evidence remote-water-smoke remote-water-test remote-water-study edgestream-water-integration cacheforge-smoke cacheforge-test cacheforge-study cacheforge-epoch2 ravel-test ravel-training-check ravel-unified-check ravel-0.4-check ravel-0.4-compiler-matrix ravel-0.4-sanitizers ravel-0.5-test ravel-0.5-evidence ravel-0.5-check ravel-0.5-development-gates ravel-0.5-negative-test ravel-0.5-manifest-negative-test ravel-0.5-compiler-matrix ravel-0.5-sanitizers ravel-0.5-runtime ravel-0.5-clean ravel-0.6-preregistration-check dsense-check dsense-avr-compile language-profile-schema language-provider-corpus multilingual-stream cacheforge-language-profile multilingual-wave-one go-profile go-provider-corpus go-gateway composed-gateway multilingual-wave-two composed-wave-three multilingual-wave-three composed-wave-four multilingual-wave-four composed-wave-five multilingual-wave-five check
