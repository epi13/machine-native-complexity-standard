...
**Operational-control plane** — release binding, monitoring, rollback, regeneration,
replacement, revalidation, and retirement.

**Pareto dominance** — no worse on every dimension and better on at least one.

**Provider** — a tool or method producing invariant evidence.

**System** — interacting components and dependencies evaluated under an explicit
composition and aggregation policy.

**UNKNOWN** — neither PASS nor FAIL established; never implicit PASS.
